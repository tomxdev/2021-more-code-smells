...
taxes = {FuelType.ELETRIC: 0.02, FuelType.PETROL: 0.05}


@dataclass
class VehicleInfoMissingError(Exception):
    """Custom error that is raised whe vehicle information is missing for a particular brand."""
...
@dataclass
class Vehicle:
    """Class representing a vehicle (eletric of fossil fuel)."""
...
class VehicleRegistry:
    ...
    def add_vehicle_model_info(
        ...
        """Helper method for addinng a VehicleModelInfo object to a list."""
    ...
    def register_vehicle(self, brand: str, model: str) -> Vehicle:
        """Create a new vehicle and generate an id a license plate."""
...
if __name__ == '__main__':
    ...
    registry.add_vehicle_model_info("Tesla", "Model 3", 50000, FuelType.ELETRIC, 2021)
    registry.add_vehicle_model_info("Volkswagen", "ID3", 35000, FuelType.ELETRIC, 2021)
    registry.add_vehicle_model_info("BMW", "520c", 60000, FuelType.PETROL, 2021)
    registry.add_vehicle_model_info("Tesla", "Model Y", 55000, FuelType.ELETRIC, 2021)
